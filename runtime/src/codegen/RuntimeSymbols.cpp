    ...
    llvm::orc::SymbolMap symbolMap;
        ...
        symbolMap[interner("eco_alloc_string_literal")] =
            llvm::orc::ExecutorSymbolDef(
                ...
                llvm::JITSymbolFlags::Exported);
        symbolMap[interner("eco_alloc_string_literal_utf8")] =
            llvm::orc::ExecutorSymbolDef(
                llvm::orc::ExecutorAddr::fromPtr(&eco_alloc_string_literal_utf8),
                llvm::JITSymbolFlags::Exported);
        ...
        symbolMap[interner("eco_alloc_closure_k")] =
            llvm::orc::ExecutorSymbolDef(
                ...
                llvm::JITSymbolFlags::Exported);
        symbolMap[interner("eco_intern_closure0")] =
            llvm::orc::ExecutorSymbolDef(
                llvm::orc::ExecutorAddr::fromPtr(&eco_intern_closure0),
                llvm::JITSymbolFlags::Exported);
        ...
        // Phase C per-instance variants.
        KERNEL_SYM(Elm_Kernel_String_fromNumber_Int)
        KERNEL_SYM(Elm_Kernel_String_fromNumber_Float)
        ...
        // Phase C per-instance variants.
        KERNEL_SYM(Elm_Kernel_List_cons_Int)
        KERNEL_SYM(Elm_Kernel_List_cons_Float)
        KERNEL_SYM(Elm_Kernel_List_cons_Char)
        ...
        // Phase B per-instance variants for Utils.compare.
        KERNEL_SYM(Elm_Kernel_Utils_compare_Int)
        KERNEL_SYM(Elm_Kernel_Utils_compare_Float)
        KERNEL_SYM(Elm_Kernel_Utils_compare_Char)
        // Phase C per-instance variants for Utils equality / ordering.
        KERNEL_SYM(Elm_Kernel_Utils_equal_Int)
        KERNEL_SYM(Elm_Kernel_Utils_equal_Float)
        KERNEL_SYM(Elm_Kernel_Utils_equal_Char)
        KERNEL_SYM(Elm_Kernel_Utils_notEqual_Int)
        KERNEL_SYM(Elm_Kernel_Utils_notEqual_Float)
        KERNEL_SYM(Elm_Kernel_Utils_notEqual_Char)
        KERNEL_SYM(Elm_Kernel_Utils_lt_Int)
        KERNEL_SYM(Elm_Kernel_Utils_lt_Float)
        KERNEL_SYM(Elm_Kernel_Utils_lt_Char)
        KERNEL_SYM(Elm_Kernel_Utils_le_Int)
        KERNEL_SYM(Elm_Kernel_Utils_le_Float)
        KERNEL_SYM(Elm_Kernel_Utils_le_Char)
        KERNEL_SYM(Elm_Kernel_Utils_gt_Int)
        KERNEL_SYM(Elm_Kernel_Utils_gt_Float)
        KERNEL_SYM(Elm_Kernel_Utils_gt_Char)
        KERNEL_SYM(Elm_Kernel_Utils_ge_Int)
        KERNEL_SYM(Elm_Kernel_Utils_ge_Float)
        KERNEL_SYM(Elm_Kernel_Utils_ge_Char)
        ...
        // kernel-opt-05: eco.string.append / eco.list.append lowering
        KERNEL_SYM(eco_string_append)
        KERNEL_SYM(eco_list_append)
        ...
        // Phase C per-instance JsArray variants.
        KERNEL_SYM(Elm_Kernel_JsArray_singleton_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_singleton_Float)
        KERNEL_SYM(Elm_Kernel_JsArray_singleton_Char)
        KERNEL_SYM(Elm_Kernel_JsArray_unsafeGet_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_unsafeSet_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_unsafeSet_Float)
        KERNEL_SYM(Elm_Kernel_JsArray_unsafeSet_Char)
        KERNEL_SYM(Elm_Kernel_JsArray_push_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_push_Float)
        KERNEL_SYM(Elm_Kernel_JsArray_push_Char)
        KERNEL_SYM(Elm_Kernel_JsArray_slice_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_appendN_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_initialize_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_initializeFromList_Int)
        KERNEL_SYM(Elm_Kernel_JsArray_indexedMap_Int)
        ...
        // Phase C per-instance variants.
        KERNEL_SYM(Elm_Kernel_Json_wrap_Int)
        KERNEL_SYM(Elm_Kernel_Json_wrap_Float)
        KERNEL_SYM(Elm_Kernel_Json_wrap_Char)

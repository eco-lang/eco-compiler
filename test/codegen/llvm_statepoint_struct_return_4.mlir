...
// callee returning {i64×4}. After RS4GC wraps the call in
...
module attributes {llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  llvm.func @callee_4() -> !llvm.struct<(i64, i64, i64, i64)> attributes {garbageCollector = "eco-gc"} {
    %0 = llvm.mlir.poison : !llvm.struct<(i64, i64, i64, i64)>
    %1 = llvm.mlir.constant(1 : i64) : i64
    %2 = llvm.insertvalue %1, %0[0] : !llvm.struct<(i64, i64, i64, i64)>
    %3 = llvm.mlir.constant(2 : i64) : i64
    %4 = llvm.insertvalue %3, %2[1] : !llvm.struct<(i64, i64, i64, i64)>
    %5 = llvm.mlir.constant(3 : i64) : i64
    %6 = llvm.insertvalue %5, %4[2] : !llvm.struct<(i64, i64, i64, i64)>
    %7 = llvm.mlir.constant(4 : i64) : i64
    %8 = llvm.insertvalue %7, %6[3] : !llvm.struct<(i64, i64, i64, i64)>
    llvm.return %8 : !llvm.struct<(i64, i64, i64, i64)>
  }
  llvm.func @caller_4() -> i64 attributes {garbageCollector = "eco-gc"} {
    %r = llvm.call @callee_4() : () -> !llvm.struct<(i64, i64, i64, i64)>
    %x = llvm.extractvalue %r[0] : !llvm.struct<(i64, i64, i64, i64)>
    llvm.return %x : i64
  }
}

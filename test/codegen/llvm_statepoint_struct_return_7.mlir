...
// callee returning {i64×7}. After RS4GC wraps the call in
...
module attributes {llvm.target_triple = "x86_64-unknown-linux-gnu"} {
  llvm.func @callee_7() -> !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)> attributes {garbageCollector = "eco-gc"} {
    %0 = llvm.mlir.poison : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %1 = llvm.mlir.constant(1 : i64) : i64
    %2 = llvm.insertvalue %1, %0[0] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %3 = llvm.mlir.constant(2 : i64) : i64
    %4 = llvm.insertvalue %3, %2[1] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %5 = llvm.mlir.constant(3 : i64) : i64
    %6 = llvm.insertvalue %5, %4[2] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %7 = llvm.mlir.constant(4 : i64) : i64
    %8 = llvm.insertvalue %7, %6[3] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %9 = llvm.mlir.constant(5 : i64) : i64
    %10 = llvm.insertvalue %9, %8[4] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %11 = llvm.mlir.constant(6 : i64) : i64
    %12 = llvm.insertvalue %11, %10[5] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %13 = llvm.mlir.constant(7 : i64) : i64
    %14 = llvm.insertvalue %13, %12[6] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    llvm.return %14 : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
  }
  llvm.func @caller_7() -> i64 attributes {garbageCollector = "eco-gc"} {
    %r = llvm.call @callee_7() : () -> !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    %x = llvm.extractvalue %r[0] : !llvm.struct<(i64, i64, i64, i64, i64, i64, i64)>
    llvm.return %x : i64
  }
}

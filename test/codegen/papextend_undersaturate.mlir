...
module {
  ...
  llvm.func @sum_four(%args: !llvm.ptr) -> !llvm.ptr<1> {
    ...
    %c_i64_as_ptr1 = llvm.inttoptr %c_i64 : i64 to !llvm.ptr<1>
    %c_ptr = llvm.call @eco_resolve_hptr(%c_i64_as_ptr1) : (!llvm.ptr<1>) -> !llvm.ptr
    ...
    %d_i64_as_ptr1 = llvm.inttoptr %d_i64 : i64 to !llvm.ptr<1>
    %d_ptr = llvm.call @eco_resolve_hptr(%d_i64_as_ptr1) : (!llvm.ptr<1>) -> !llvm.ptr
